...
public class GT4500 implements SpaceShip {
  ...
  public boolean fireLaser(FiringMode firingMode, TorpedoStore primaryTorpedoStore,
    ...
    switch (firingMode) {
      case SINGLE:
        if (wasPrimaryFiredLast) {
          ...
          if (!primaryTorpedoStore.isEmpty()) {
            ...
            // although secondary was fired last, but primary is empty
      ...
      case ALL:
        ...
        if (!primaryTorpedoStore.isEmpty() && !secondaryTorpedoStore.isEmpty()) {
          boolean firstShot = primaryTorpedoStore.fire(1);
          boolean secondShot = secondaryTorpedoStore.fire(1);
